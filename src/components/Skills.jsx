                    ...
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p className="mt-2 max-w-2xl text-slate-300">
                                Toggle the dark mode preview using JavaScript. This section updates
                                the page theme by adding or removing the
                                <span className="font-semibold text-white"> dark</span> class on the
                                document root.
                            </p>
                        </div>
                        <button
